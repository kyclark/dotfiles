...
alias cx='chmod +x'
alias lr='ls -ltr'
alias ws='dx run -imax_session_length="1d" cloud_workstation --ssh -y'
...
path+=/Users/kyclark@dnanexus.com/Library/Python/3.11/bin
path+=$JAVA_HOME/bin
...
plugins=(git rust thefuck dirhistory)
...
alias pstart='brew services restart postgresql@15'
